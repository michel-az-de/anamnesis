...
- Green completo local: 280 de 280 testes Release aprovados na branch Windows integrada. Os runs `31099937896`, `31100566863`, `31101580716`, `31104316644`, `31105631929` e `31106730785` revelaram, respectivamente, rejeicao do Worker legado, flutuacao no stress do journal, uma tentativa invalida de reparo com o instalador legado, contencao do `ThreadPool` no sinal de instancia unica, reutilizacao do caminho `HKCU` depois da migracao elevada para `HKLM` e reativacao indevida da tarefa de startup; as seis regressoes possuem testes e correcoes locais e aguardam nova execucao instalada.
