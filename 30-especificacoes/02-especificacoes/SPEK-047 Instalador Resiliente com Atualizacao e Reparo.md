...
- O primeiro ramo que bloqueia o downgrade, inclusive no wizard silencioso, persiste no log a causa explicita `downgrade automatico` antes de abortar. Uma mensagem existente apenas em um preflight posterior que nao foi alcancado nao constitui evidencia.
...
- `InstallerContractTests`: 20 de 20 verdes; contratos de instalador e release: 21 de 21 verdes.
- Suite integrada atual: 281 de 281 testes verdes em Release; `dotnet format --verify-no-changes` e parsers PowerShell verdes.
