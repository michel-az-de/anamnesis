...
| Solução .NET, qualidade e TDD inicial | 5% | 100% | 5% | Solução compilável e 274 testes automatizados verdes, incluindo OBS, Docker, Tray, Worker black box, Desktop real, observabilidade, motion, detecção local e release Windows |
...
| Instalador resiliente com atualização e reparo | Em validação | Termos simples, diagnóstico, comparação binária com Tray canônico, Worker legado tratado como reparo, orientação para instalar, atualizar ou reparar e encerramento cooperativo compilados com Inno Setup 6.7.3; suíte Release atual com 274 testes verdes. Falta o smoke ampliado em runner Windows limpo ([[SPEK-047 Instalador Resiliente com Atualizacao e Reparo]]) |
