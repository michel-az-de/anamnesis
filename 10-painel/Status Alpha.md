...
| Solução .NET, qualidade e TDD inicial | 5% | 100% | 5% | Solução compilável e 276 testes automatizados verdes, incluindo OBS, Docker, Tray, Worker black box, Desktop real, observabilidade, motion, detecção local e release Windows |
...
| Instalador resiliente com atualização e reparo | Em validação | Termos simples, diagnóstico, comparação binária com Tray canônico, preservação do Tray legado, probe moderno de downgrade e encerramento cooperativo cobertos por 276 testes verdes; probe efêmero compilado com Inno Setup 6.7.3. Falta o smoke ampliado em runner Windows limpo ([[SPEK-047 Instalador Resiliente com Atualizacao e Reparo]]) |
