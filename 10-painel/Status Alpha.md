...
| Instalador resiliente com atualização e reparo | Em validação | Termos simples, diagnóstico, comparação binária com Tray canônico, Worker legado tratado como reparo, orientação para instalar, atualizar ou reparar e encerramento cooperativo compilados com Inno Setup 6.7.3; 268 testes Release verdes. Falta o smoke ampliado em runner Windows limpo ([[SPEK-047 Instalador Resiliente com Atualizacao e Reparo]]) |
