...
| Instalador resiliente com atualização e reparo | Em validação | Termos simples, diagnóstico, comparação binária segura, orientação para instalar, atualizar ou reparar e encerramento cooperativo compilados com Inno Setup 6.7.3; 266 testes Release verdes. Falta o smoke ampliado em runner Windows limpo ([[SPEK-047 Instalador Resiliente com Atualizacao e Reparo]]) |
